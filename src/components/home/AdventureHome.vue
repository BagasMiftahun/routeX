    ...
    <div class="container">
      <div class="row">
        <div class="section-title2 mb-60">
          <div class="section-title2__wrapper">
            <span
              class="section-title2__wrapper-subtitle wow fadeInLeft animated"
              data-wow-delay=".2s"
              >Available Countries
              <svg
                width="52"
            ...
            <h2
              class="section-title2__wrapper-title wow fadeInLeft animated"
              data-wow-delay=".3s"
            >
          ...
          <div
            class="section-title2__button wow fadeInLeft animated"
            data-wow-delay=".4s"
          >
      ...
      <div class="row mb-minus-30">
        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
          <div
            class="adventure__item mb-30 wow fadeInLeft animated"
            data-wow-delay=".2s"
          >
            ...
            <div class="adventure__item-content">
              ...
              <div class="adventure__item-content-list mt-20">
                <ul>
                  ...
                  <li class="mt-10">
                    <i class="fa-solid fa-check"></i>Your Startup
                  </li>
                  <li class="mt-10">
                    <i class="fa-solid fa-check"></i>Knew About Fonts
                  </li>
                </ul>
              </div>
            </div>
