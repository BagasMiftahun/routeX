  ...
  <section class="testimonial__area section-space-top gray-bg">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-7">
          <div
            class="testimonial__content swiper wow fadeInLeft animated"
            data-wow-delay=".3s"
          >
            ...
            <div class="testimonial__content-button d-flex">
              ...
              <button class="testimonial-prev testimonial__content-button-btn">
                <i class="fa-solid fa-arrow-left"></i>
              </button>
              <button class="testimonial-next testimonial__content-button-btn">
