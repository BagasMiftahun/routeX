      ...
      <div class="container">
        <div class="section-slider-title mb-60">
          <div class="section-slider-title-wrapper">
            <h6
              class="section-slider-title-wrapper-subtitle wow fadeInLeft animated"
              data-wow-delay=".2s"
            >
              <svg
                width="20"
            ...
            <h2
              class="section-slider-title-wrapper-title wow fadeInLeft animated"
              data-wow-delay=".3s"
            >
          ...
          <div class="section-slider-title-button">
            ...
            <div class="d-block d-md-none">
              <button
                class="section-slider-title-button-right mr-15 project__slider-button-prev-2 wow fadeInLeft animated"
                data-wow-delay=".4s"
              >
                <i class="fa-solid fa-arrow-left"></i>
              </button>
              <button
                class="section-slider-title-button-right project__slider-button-next-2 wow fadeInLeft animated"
                data-wow-delay=".5s"
              >
                <i class="fa-solid fa-arrow-right"></i>
              </button>
              ...
              <div class="swiper-slide p-relative">
                <div class="project-three__single">
                  <ul class="slider_hover__item">
                    <li>
                      <div
                        class="project-three__single-inner wow fadeInLeft animated"
                        data-wow-delay=".2s"
                      >
                        ...
                        <div class="project-three__single-content">
                          <h4>Working Visa</h4>
                          <p>
                            Lorem Ipsum is simply dummy text the <br />
                            printing and provide best visa ever
                          </p>
        ...
        <div class="project-row-custom-2 d-block d-md-none">
          <div class="swiper project-slide-2">
            <div class="swiper-wrapper">
              <div class="swiper-slide p-relative">
                <div
                  class="project-three__single-inner min-vh-100 wow fadeInLeft animated"
                  data-wow-delay=".2s"
                >
                  <div class="project-small-img">
                    <img
                  ...
                  <div
                    class="project-three__single-img mh-100"
                    :style="{ backgroundImage: `url(${projectImage1})` }"
                  ></div>
                  <div class="bg-overlay"></div>
