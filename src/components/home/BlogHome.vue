<template>
  ...
  <section
    class="latest-blog__area section-space-bottom overflow-hidden gray-bg"
  >
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="section-slider-title-3 mb-60">
            <div class="section-slider-title-3-wrapper">
              <h6
                class="section-slider-title-3-wrapper-subtitle wow fadeInLeft animated"
                data-wow-delay=".2s"
              >
                <svg
                  width="20"
              ...
              <h2
                class="section-slider-title-3-wrapper-title wow fadeInLeft animated"
                data-wow-delay=".3s"
              >
                Journeys of Discovery <br />
                Uncovering Hidden
              </h2>
            </div>
              ...
              <div class="swiper-wrapper">
                    ...
                    <div class="latest-blog__item-text">
                      <div class="latest-blog__item-text-meta d-flex">
                        <span class="meta-comment"
                          ><a href="blog-details.html"
                            ><i class="fa-solid fa-calendar-days"></i> October
                            19, 2022</a
                          ></span
                        >
                        <span
                ...
                >
                  ...
                  <div class="latest-blog__item-text">
                    ...
                    <div class="latest-blog__item-text-bottom">
                      <a href="blog-details.html"
                        ><h4>
                          Search of Serenity Tranquil Retreats and Escapes
                        </h4></a
                      >
                      <p>
                ...
                >
                  ...
                  <div class="latest-blog__item-text">
                    ...
                    <div class="latest-blog__item-text-bottom">
                      <a href="blog-details.html"
                        ><h4>Road to Adventure Embarking on New Horizons</h4></a
                      >
                      <p>
                        Lorem Ipsum is simply dummy text the printing and typese
                        Lorem Ipsum
