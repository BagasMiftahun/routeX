        ...
        <div class="col-12">
          <div class="section-slider-title-2 mb-60">
            <div class="section-slider-title-2-wrapper">
              <h6
                class="section-slider-title-2-wrapper-subtitle wow fadeInLeft animated"
                data-wow-delay=".2s"
              >
                <svg
                  width="20"
              ...
              <h2
                class="section-slider-title-2-wrapper-title wow fadeInLeft animated"
                data-wow-delay=".3s"
              >
                A Tapestry of Experiences <br />
                Cultural Encounters
              </h2>
            </div>
