              ...
              <div className="row align-items-center">
                <div className="col-md-6 ">
                  <div className="banner-home__content p-relative">
                    <h1
                      className="title mb-xs-10 wow fadeInLeft animated"
                      data-wow-delay=".4s"
                    >
                    ...
                    <div className="banner-home__btn__wrapper d-flex flex-wrap mt-40 mt-md-35 mt-sm-30 mt-xs-25">
                      <a
                        href="about-us.html"
                        className="rr-btn btn-transparent wow fadeInLeft animated"
                        data-wow-delay=".6s"
                      >
                        Read More <i className="fa-solid fa-arrow-right" />
                      </a>
                      <a
                        href="https://www.youtube.com/watch?v=_ZmB5RdUgPQ"
                        className="popup-video zooming banner-video-button"
                      ...
                      <a
                        className="video-text wow fadeInLeft animated"
                        data-wow-delay=".8s"
                ...
                <div className="col-md-6 ">
                  <div
                    className="banner-home__shape position-relative wow fadeInLeft animated"
                    data-wow-delay=".9s"
                  >
