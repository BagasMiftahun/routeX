    ...
    <div class="container">
      <div class="row">
        <div class="section__title-wrapper text-center mb-50">
          <h6
            class="section__title-wrapper-center-subtitle mb-10 wow fadeInLeft animated"
            data-wow-delay=".2s"
          >
            <svg
              width="21"
      ...
      <div class="row mb-minus-30">
        <div class="col-lg-6">
          <div
            class="visa__item visa__item-2 mb-30 d-flex align-items-center wow fadeInLeft animated"
            data-wow-delay=".2s"
          >
            ...
            <div class="visa__item-content">
              ...
              <div
                class="visa__item-content-button mt-30 d-flex justify-content-between"
              >
