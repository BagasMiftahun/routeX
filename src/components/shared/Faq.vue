    ...
    <div class="faq__area">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-8">
            <div
              class="faq__content white-bg d-flex faq-radius position-relative overflow-hidden"
            >
              <div class="faq__content-text faq-padding">
                <div
                  class="faq__content-text-icon wow fadeInLeft animated"
                  data-wow-delay=".2s"
                >
                  <svg
                    width="45"
                ...
                <h5 class="wow fadeInLeft animated" data-wow-delay=".3s">
                  Get our best offers quickly
                </h5>
                <p class="wow fadeInLeft animated" data-wow-delay=".4s">
                ...
                <a
                  href="contact.html"
                  class="rr-btn2 mt-25 wow fadeInLeft animated"
                  data-wow-delay=".5s"
                  >Contact us <i class="fa-solid fa-arrow-right"></i
                ></a>
              </div>
              <div
                class="faq__content-right-img wow fadeInLeft animated"
                data-wow-delay=".6s"
              >
                <img
            ...
            <div class="row counter__bg mt-30 mb-minus-20">
              <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="counter__item mb-20">
                  <h3 class="counter__item-title">
                    <span class="odometer" data-count="10">0</span>k+
                  </h3>
